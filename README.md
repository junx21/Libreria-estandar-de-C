...
b. Funciones rand() y srand()
Usa la función rand() para generar un número aleatorio. Luego, usa srand() para cambiar la semilla de la generación de números aleatorios y observa cómo cambian los números generados.
c
#include <stdlib.h>
#include <stdio.h>
#include <time.h>
...
2. Cadenas (<string.h>)
a. Función strcmp()
Crea dos cadenas de caracteres y usa la función strcmp() para compararlas. Prueba con cadenas iguales y diferentes.
c
#include <string.h>
#include <stdio.h>
...
b. Función strlen()
Usa la función strlen() para calcular la longitud de una cadena.
c
#include <string.h>
#include <stdio.h>
...
3. Archivos (<stdio.h>)
a. Función fopen()
Usa la función fopen() para abrir un archivo de texto. Si el archivo no existe, muestra un mensaje de error.
c
#include <stdio.h>
...
b. Funciones fprintf() y fscanf()
Escribe en un archivo de texto usando fprintf(). Después, lee lo que escribiste usando fscanf().
c
#include <stdio.h>
...
Guía para CLion: Ejercicio de Comparación de Cadenas
...
Haz clic en "OK".
Paso 3: Escribe el código del ejercicio
Copia y pega el siguiente código en tu nuevo archivo de código C:
c
#include <string.h>
#include <stdio.h>
